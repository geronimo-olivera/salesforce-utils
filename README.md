...
[`manifest/package.xml`](manifest/package.xml) currently only lists the Trigger Handler Framework's components. As more utilities are added, either extend this manifest or give each utility its own.
